...
int main() {
    Mahasiswa* ptrMahasiswaAktif = new MahasiswaAktif("Egi Abdul Azis Saputra", 19, "Teknologi Informasi", "Informatika dan Pariwisata");
    cout << "Informasi Mahasiswa Aktif:" << endl;
    ptrMahasiswaAktif->dataMahasiswa();
    delete ptrMahasiswaAktif;
    cout << endl;

    Mahasiswa* ptrMahasiswaAlumni = new MahasiswaAlumni("kiki", 25, "Pariwisata", "informatika dan pariwisata");
